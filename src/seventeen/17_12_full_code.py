...
460 | Neural Networks from Scratch
# ReLU activation
...
self.decay = decay
462 | Neural Networks from Scratch
self.iterations = 0
...
def post_update_params(self):
self.iterations += 1
464 | Neural Networks from Scratch
# RMSprop optimizer
...
466 | Neural Networks from Scratch
...
468 | Neural Networks from Scratch
...
470 | Neural Networks from Scratch
# Calculate gradient
